namespace KianCommons {
    public struct DynamicFlags2 {
        ...
        public static bool IsAnyFlagSet(DynamicFlags<byte> flags, DynamicFlags<byte> flags2) {
            return DynamicFlags<byte>.CheckAny(flags, new DynamicFlags<byte>(EMPTY_FLAGS), flags2);
        }
